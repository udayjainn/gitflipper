...
const HOOK_MARKER = '# gitflipper-pre-commit-guard';
const EXPECTED_FILE = 'gitflipper-expected';
...
function buildHookScript(): string {
  return [
    ...
    '  echo ""',
    '  echo "========================================"',
    '  echo "  Commit blocked by GitFlipper"',
    '  echo "========================================"',
    '  echo ""',
    ...
    '  echo "    2. Type: GitFlipper: Switch Profile"',
